...
- Activities:
    ...
    - Tanama River Adventures: **xxx$**
    - Biobay tour in Vieques with JAK Watersports: **55$ per person** (because we paid cash). Add another 5$ per person if you pay with a credit card.
    - Diving and snorkeling with : **xxx$**. Because of the weather, we unfortunately had to cancel the dives and snorkeling that day.
